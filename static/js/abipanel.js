...
function innerTextFormat(stringIN){
    ...
    if(stringIN=="gdi"){return function(number){return d3.format('.3s')(number)};}
...
function sizeCircles(stringIN){
    ...
    sizeC = {}
    sizeC["gdi"] = [widthPanel/1.2,heightPanel/3.3];
